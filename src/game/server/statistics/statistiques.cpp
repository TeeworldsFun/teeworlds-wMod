...
void CStats::UpdateUpgrade()
{
	...
	m_upgr.m_stat_weapon.m_auto[WEAPON_GUN] = m_upgr.m_weapon >= 1 ? true : false;
	m_upgr.m_stat_weapon.m_auto[WEAPON_HAMMER] = m_upgr.m_weapon >= 2 ? true : false;
	m_upgr.m_stat_weapon.m_auto[WEAPON_NINJA] = m_upgr.m_weapon >= 3 ? true : false;
