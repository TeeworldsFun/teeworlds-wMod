...
public:
    ...
    int Type()
    {
        return m_TypeAndID>>16;
    }
    int ID()
    {
        return m_TypeAndID&0xffff;
    }
    int Key()
    {
        return m_TypeAndID;
...
class CSnapshot
{
    ...
    {
        return (char*)(Offsets()+m_NumItems);
    }
...
public:
    ...
    {
        return m_aSnapshotDataRate[Index];
    }
    int GetDataUpdates(int Index)
    {
        return m_aSnapshotDataUpdates[Index];
    }
