...
protected:
    ...
    {
        return m_aInputState[m_InputCurrent^1][Key];
    }
...
public:
    ...
    int KeyReleases(int Key)
    {
        return m_aInputCount[m_InputCurrent][Key].m_Releases;
    }
    int KeyPresses(int Key)
    {
        return m_aInputCount[m_InputCurrent][Key].m_Presses;
    }
    int KeyDown(int Key)
    {
    ...
    {
        return (Key >= 0 && Key < 512) ? g_aaKeyStrings[Key] : g_aaKeyStrings[0];
    }
