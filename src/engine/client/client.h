...
public:
    ...
    IEngineMasterServer *MasterServer()
    {
    ...
    {
        return m_RconAuthed != 0;
    }
    virtual bool UseTempRconCommands()
    {
        return m_UseTempRconCommands != 0;
    }
    ...
    virtual bool SoundInitFailed()
    {
        return m_SoundInitFailed;
    }

    virtual int GetDebugFont()
    {
        return m_DebugFont;
    }
    ...
    virtual int MapDownloadAmount()
    {
        return m_MapdownloadAmount;
    }
    virtual int MapDownloadTotalsize()
    {
        return m_MapdownloadTotalsize;
    }
